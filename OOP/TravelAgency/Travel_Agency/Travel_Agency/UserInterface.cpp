...
=======
>>>>>>> 0e98786e1e605535b168fa2c5265bf61cf2746f9
	std::cout << "4. Display tourist offers" << "\n";
	std::cout << "5. Find tourist offer by name" << "\n";
	std::cout << "6. Filter tourist offers by destination" << "\n";
	std::cout << "7. Filter tourist offers by price" << "\n";
	std::cout << "8. Sort tourist offers by name" << "\n";
	std::cout << "9. Sort tourist offers by destination" << "\n";
	std::cout << "10. Sort tourist offers by type and price" << "\n";
	std::cout << "11. Show cart(wish list)" << "\n";
	std::cout << "12. Empty cart: delete all offer from the cart" << "\n";
	std::cout << "13. Add to cart: add to cart a tourist offer by name" << "\n";
	std::cout << "14. Generate cart: the user enters the total number of offers, the cart itself populates randomly with tourist offers" << "\n";
	std::cout << "15. The number of tourist offers for each destination" << "\n";
<<<<<<< HEAD
>>>>>>> 0e98786e1e605535b168fa2c5265bf61cf2746f9
=======
>>>>>>> 0e98786e1e605535b168fa2c5265bf61cf2746f9
